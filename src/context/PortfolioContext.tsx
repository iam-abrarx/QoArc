...
const defaultTestimonials: Testimonial[] = [
  ...
  { id: '5', company: "Nazmus Sakib Pharmacy", logoColor: "text-[#008080]", authorName: "Nazmus Sakib", authorTitle: "Owner", authorImage: "https://69c86795a9fb0ef7c012e385.imgix.net/testimonial%20male.jpg", authorLinkedin: "#", rating: 5, content: "QOARC developed a fast, reliable inventory management system for our local pharmacy. It helps us keep track of medicines, sales, and stock levels effortlessly. The system is easy to use and has completely modernized our daily operations.", companyUrl: "#", projectUrl: "#" },
];
